...
def invert(inv_dict_parameter: dict[str, str]) -> dict[str, str]:
    ...
    for key in inv_dict_parameter:
        if inv_dict_parameter[key] in inverted_dict_output:  #DOES inv_dict_parameter[key] RETURN THE VALUES OF inv_dict_parameter?
...
# for ojdsafdsafsaofdsa in dict:
#     if 

# # edge cases examples: empty dictionary, 
# # use case examples: assignment page has them
