...
while index_counter_of_guess < len(secret_word):
    if secret_word_guess[index_counter_of_guess] == secret_word[index_counter_of_guess]:
        ...
        while guessed_chr_exist_elsewhere == False and index_counter_of_guess < len(secret_word):
            if secret_word[index_counter_of_guess] == secret_word_guess[index_counter_of_guess]:
